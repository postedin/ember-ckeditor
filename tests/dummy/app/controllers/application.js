...
export default class ApplicationController extends Controller {
  ...
  get editors() {
    return [
      {
        name: 'Postedin Classic Editor',
        editor: ClassicEditor,
        value: '<p><img src="image.png" /></p>',
        options: {
          language: 'en',
          link: {
