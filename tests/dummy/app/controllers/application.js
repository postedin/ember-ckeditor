...
import { ClassicEditor, CommentEditor, DecoupledEditor } from '@postedin/ckeditor5-build-combined';
...
export default class ApplicationController extends Controller {
  ...
  get editors() {
    return [
      ...
      {
        name: 'Decoupled Document Editor',
